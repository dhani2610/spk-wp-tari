      ...
      <div class="card-header bg-gray1" style="border-radius:10px 10px 0px 0px;">
        <div class="row">
          ...
          <div class="col-6 d-flex justify-content-end">
            <a href="{{ route('sanggar-tari-create') }}" class="btn btn-md btn-info">
          ...
          <tbody>
            ...
            @foreach ($sanggar as $item)
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{ route('sanggar-tari-edit', $item->id) }}" class="btn btn-warning text-white">
                      <i class="far fa-edit"></i>
                      Edit
                    </a>
                    <a href="{{ route('sanggar-tari-delete', $item->id) }}" class="btn btn-danger f-12">
