    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Main Menu</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">Home</li>
                        <li class="breadcrumb-item">/</li>
                        <li class="breadcrumb-item active"><a href="{{ route('dashboard.index') }}">Main Menu</a></li>
                    </ol>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-12 p-1" onclick="location.href='{{ route('departements.index') }}';">
                <div class="info-box bg-gradient-info master-data">
                    <span class="info-box-icon" style="background-color:#4e73df; "><i class="fas fa-building text-white"></i></span>
            ...
            <div class="col-md-4 col-sm-6 col-12 p-1" onclick="location.href='{{ route('users.index') }}';">
                <div class="info-box bg-gradient-info master-data">
                    <span class="info-box-icon" style="background-color:#4e73df; "><i class="fas fa-user text-white"></i></span>
